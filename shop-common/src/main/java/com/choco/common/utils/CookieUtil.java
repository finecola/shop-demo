package com.choco.common.utils;
...
/**
 * Created by choco on 2021/1/5 22:41
 */
public final class CookieUtil {
     ...
     */
    private static final void doSetCookie(HttpServletRequest request, HttpServletResponse
            response,
    ...
    private static final String getDomainName(HttpServletRequest request) {
        ...
        if (serverName == null || serverName.equals("")) {
            ...
            if (len > 3) {
                // www.xxx.com.cn
                domainName = domains[len - 3] + "." + domains[len - 2] + "." + domains[len
                        - 1];
            } else if (len <= 3 && len > 1) {
                // xxx.com or xxx.cn
