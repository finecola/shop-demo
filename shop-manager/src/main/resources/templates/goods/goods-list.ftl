...
<head>
    ...
    <script src="${ctx}/static/js/doT.min.js"></script>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="goodsName" id="goodsName" value="" placeholder="搜索词"
                                           class="formcontrol" type="text">
                                </div>
                            </div>
                            <!--排序规则-->
                            <input name="orderby1" value="goods_id" type="hidden">
                            <input name="orderby2" value="desc" type="hidden">
                            <button type="button" onclick="ajax_get_table(1)" id="button-filter search-order"
