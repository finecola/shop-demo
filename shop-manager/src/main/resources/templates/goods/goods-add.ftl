...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="${ctx}/static/plugins/Ueditor/lang/zh-cn/zhcn.js"></script>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_goods_images" data-toggle="tab" onclick="checkHasGoods();">商品相册
                            </a></li>
                    ...
                    <form method="post" id="addEditGoodsForm">
                        ...
                        <div class="pull-right">
                            <input type="hidden" name="goods_id" id="goodsId" value="">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var options = {
            ...
            focus: false, //初始化时，是否让编辑器获得焦点true或false
            maximumWords: 99999,
            removeFormatAttributes: 'class,style,lang,width,height,align,hspace,valign', //允许的最大字符
            数 'fullscreen',
            pasteplain: false, //是否默认为纯文本粘贴。false为不使用纯文本粘贴，true为使用纯文本粘贴
            autoHeightEnabled: true
            /*   autotypeset: {
...
center,left,right,none 去掉这个属性表示不执行排版
                   ...
                   clearFontSize: false,       //去掉所有的内嵌字号，使用编辑器默认的字号
                   clearFontFamily: false,     //去掉所有的内嵌字体，使用编辑器默认的字体
智者乐水 仁者乐山 程序员 乐字节 5 如果需要更多优质的Java、Python、架构、大数据等IT资料请加微信：lezijie007
                   removeEmptyNode: false,     //去掉空节点
                                               //可以去掉的标签
                   removeTagNames: {"font": 1},
                   indent: false,               // 行首缩进
