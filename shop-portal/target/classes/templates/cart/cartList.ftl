        ...
        <div id="s_bd">
            ...
            <div class="cartlist">
                <table width="100%">
                    ...
                    <tr bgcolor="#fffaf1">
                        <td>
                            <a href="#"><img class="smallpic" src="${ctx}/static/images/12sdfv.jpg" width="80" height="80"/></a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="addinput">
                                <input type="text" name="qty_item_2" value="1" id="qty_item_2"
                                       onblur="setAmount.modify('#qty_item_2')" class="stext"/>
                                <a class="add" onClick="setAmount.add('#qty_item_2')" href="javascript:void(0)"></a>
                                <a class="reduce" onClick="setAmount.reduce('#qty_item_2')"
                                   href="javascript:void(0)"></a>
                            </div>
                        </td>
                        <td>有货，可当日出货</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="addinput">
                                <input type="text" name="qty_item_3" value="1" id="qty_item_3"
                                       onKeyUp="setAmount.modify('#qty_item_3')" class="stext"/>
                                <a class="add" onClick="setAmount.add('#qty_item_3')" href="javascript:void(0)"></a>
                                <a class="reduce" onClick="setAmount.reduce('#qty_item_3')"
                                   href="javascript:void(0)"></a>
                            </div>
                        </td>
                        <td>有货，可当日出货</td>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="5">
                            <p>共3件商品，总重3.580kg</p>
                            <p style="margin-top:10px;font-size:14px;">总计金额(不含运费)：￥2206.00(商品金额) - ￥0.00(返现金额)= <strong
                                        style="font-size:18px;color:#d80000;">￥2206.00</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="border:none;padding-top:20px;" colspan="6"><input type="button" value="" id=""
                                                                                     class="btnimg f-r"/><a
                                    class="f-r goonbtn" href="#"><img src="${ctx}/static/images/gooncat.gif" width="86" height="24"
                                                                      alt=""/></a></td>
                    </tr>
                </table>
            </div><!--cartlist end-->
