...
<div id="doc">
                    ...
                    <form id="formlogin" onsubmit="return false;">
                        ...
                        <div class="form" style="width:600px;">
                            ...
                            <div class="item">
                                ...
                                <div class="fl">
                                    <input type="password" name="password" id="loginpwd" class="text" tabindex="2">
                                    <label id="loginpwd_succeed" class="blank invisible"></label>
                                    <label><a href="for.html" class="blue">忘记密码?</a></label>
                                    <span class="clear"></span>
                            ...
                            <div class="item">
                                ...
                                <div class="fl">
                                    <input type="checkbox" id="jz" name="dl" value=""/>
                                    <label for="jz">记住用户名</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                    <input type="checkbox" id="zd" name="dl" value=""/>
    ...
    <div id="s_ftw">
        ...
        <div id="s_ft">
            ...
            <div class="copyright tac pbt10"></div>
