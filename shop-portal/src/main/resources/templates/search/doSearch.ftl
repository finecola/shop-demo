            ...
            <div class="s_hd">
                <div id="s_search">
                    <form id="s_search_form" onsubmit="return false">
                        ...
                        <input name="keyword" value="${keyword}" type="text" class="search-input"/>
            ...
            <div class="f-r rightlist">
                        ...
                        <ul class="cf">
                            <li>
                                ...
                                <dl>
                                    ...
                                    <dd><a class="addcat" onclick="addToCart()">加入购物车</a></dd>
                                </dl>
                            </li>
                            <li>
                ...
                <div class="productlist">
                    <ul id="s_search_content">
                        <li>
                            <a href="#"><img src="${ctx}/static/images/21asfa.jpg" width="170" height="160"
                                             alt=""/></a>
                            <dl>
                                <dt><a href="#">凌仕魅动男士香氛-契合</a></dt>
                                <dd>特价：<strong class="red">￥52.9</strong></dd>
    ...
    <li>
        ...
        <dl>
            ...
            <dd><a class="addcat" href="javascript:void(0);"
                   onclick="addToCart('{{=it[i].goodsId}}', '{{=it[i].goodsName}}',
'{{=it[i].marketPrice}}', '{{=it[i].originalImg}}');">加入购物车</a>
            </dd>
        </dl>
    </li>
    {{ } }}
...
<script type="template" id="pageTemplate">
    <div class="f-r pagination">
        ...
        {{ } }}
        <div class="yepage">
            到第<input class="stext" type="text" name="" id="" value="1"/>页
