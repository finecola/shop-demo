					...
					<tr>
						...
						<td class="summary">
							<table class="address" width="100%">
								...
								<tr>
									<td><span class="red">*</span>手机：</td><td><input type="text" name="" value="如13612345678" id="" class="stext focutext00" /></td>
								</tr>
						...
						<td class="summary">
							<table class="address" width="100%">
								<tr>
									...
									<td valign="top">货到付款,<span class="red">EGO快递可刷卡</span>，免手续费；<span class="red">第三方EGO快递只能使用现金；可使用支票</span><br />(1.支票抬头：上海EGO电子商务发展有限公司；2.支票限额：每个订单支票支付限额为4万；3.暂不接受非上海公司的支票)</td>
								</tr>
								...
								<tr>
									...
									<td valign="top">通过银行转账或现金直接存入EGO网指定帐号（查看汇款单填写范本），<span class="red">[汇款用途]-栏需注明订单号</span></td>
								</tr>
								<tr><td height="10px"></td></tr>
								<tr>
									<td valign="top" width="10px"></td>
									...
									<table class="totable" width="100%">
										...
										<tr>
											...
											<td align="right"><strong
														style="font-size:18px;color:#dc0000;">￥${cartResult.totalPrice}
												</strong>
											</td>
										</tr>
										<tr>
